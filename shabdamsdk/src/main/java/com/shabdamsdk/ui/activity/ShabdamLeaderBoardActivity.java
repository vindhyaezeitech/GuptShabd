...
public class ShabdamLeaderBoardActivity extends AppCompatActivity implements GameView, View.OnClickListener {
                ...
                public void onClick(View view) {
                    if (ShabdamLeaderBoardActivity.this != null) {
                        if (ToastUtils.checkInternetConnection(ShabdamLeaderBoardActivity.this)) {
                            ...
                            Toast.makeText(ShabdamLeaderBoardActivity.this, getString(com.shabdamsdk.R.string.ensure_internet), Toast.LENGTH_SHORT).show();
                        }
                    }
                }
            });
